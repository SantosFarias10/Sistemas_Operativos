...
Necesitaremos dos registros de hardware en cada CPU: uno es llamado registro **base**, y el otro **limite**. Este par base-limite nos permite ubicar en el espacio de direcciones en cualquier lugar que querramos de la memoria física, y asi asegurarnos que el proceso solo puede acceder a su espacio de direcciones.
